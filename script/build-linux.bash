...
####
PROJECT_CJSON_WITH_DISABLED_TEST_APPS="${MY_PROJECT_CJSON_WITH_DISABLED_TEST_APPS:=OFF}"
...
if [ "ON" = "$PROJECT_CJSON_WITH_DISABLED_TEST_APPS" ]; then
    MY_CMAKE_COMMON_ARGUMENT_LIST+=("-DCJSON_WITH_DISABLED_TEST_APPS=$PROJECT_CJSON_WITH_DISABLED_TEST_APPS")
fi
...
echo "[$SYSTEM_PLATFORM] Component information: cJSON with disabled test apps: $PROJECT_CJSON_WITH_DISABLED_TEST_APPS"
